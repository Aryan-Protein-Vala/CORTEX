...
const faqs = [
  ...
  ['What if I want to turn off memory decay?', 'CORTEX_DECAY_POLICY=off and nothing is ever mutated; =soft (the default) flags faded below 0.25 and ranks it out of your briefings; =prune actually deletes below 0.05 (hard and delete work as aliases). Pin anything with cortex_lock and it survives every policy, including prune. But trust me, you say a lot of useless shit — let the curve do its job.'],
